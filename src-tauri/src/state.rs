...
pub struct AppState {
    ...
    pub cleanup_jobs: Arc<Mutex<HashMap<String, Arc<AtomicBool>>>>,
    pub active_cleanup_scan: Arc<Mutex<Option<ScanJob>>>,
    pub cleanup_delete_jobs: Arc<Mutex<HashMap<String, Arc<AtomicBool>>>>,
    pub active_cleanup_delete: Arc<Mutex<Option<ScanJob>>>,
...
impl Default for AppState {
    fn default() -> Self {
        Self {
            ...
            cleanup_jobs: Arc::new(Mutex::new(HashMap::new())),
            active_cleanup_scan: Arc::new(Mutex::new(None)),
            cleanup_delete_jobs: Arc::new(Mutex::new(HashMap::new())),
            active_cleanup_delete: Arc::new(Mutex::new(None)),
